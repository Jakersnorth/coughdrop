...
var Button = Ember.Object.extend({
  ...
  sidebar_html: function() {
    ...
    res = res + "<div style='display:block;width:100%;overflow:hidden;'>";
    res = res + "<span class='button-label'>" + clean_text(this.get('label')) + "</span>";
    res = res + "</div>";

    res = res + "</div>";
    return new Ember.String.htmlSafe(res);
  }.property('refresh_token', 'computed_style', 'computed_class', 'label', 'image_holder_style', 'local_image_url', 'image_style'),
